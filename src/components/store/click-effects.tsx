...
/**
 * Efeito decorativo de clique (Originkit), rodando fixo em toda a tela.
 * pointerEvents "none" do lado de fora garante que nunca intercepta
 * cliques em botões/links reais — a captura roda no `document`, não no
 * container, então funciona em qualquer página sem atrapalhar a loja.
 */
